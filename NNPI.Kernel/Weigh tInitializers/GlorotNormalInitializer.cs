...
{
    /// <summary>
    /// GlorotNormalInitializer class that initializes the weights of a matrix with random values sampled from a normal (Gaussian) distribution
    /// with parameters defined by the Glorot (Xavier) initialization method.
    /// </summary>
    public class GlorotNormalInitializer : WeightInitializer
    {
        private Random random;

        /// <summary>
        /// Initializes a new instance of the GlorotNormalInitializer class.
        /// </summary>
