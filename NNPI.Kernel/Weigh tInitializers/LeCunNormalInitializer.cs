...
{
    /// <summary>
    /// LeCunNormalInitializer class that initializes the weights of a matrix with random values sampled from a normal (Gaussian) distribution
    /// with parameters defined by the LeCun initialization method.
    /// </summary>
    public class LeCunNormalInitializer : WeightInitializer
    {
        private Random random;

        /// <summary>
        /// Initializes a new instance of the LeCunNormalInitializer class.
        /// </summary>
        public LeCunNormalInitializer()
        {
            random = new Random();
        }
